  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          transform: `translate(${cursorX * 130}px, ${sectionProgress * 150 + cursorY * 80}px)`,
        }}
      />
      <div
        className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-secondary/12 rounded-full blur-3xl"
        style={{
          transform: `translate(${-cursorX * 110}px, ${-sectionProgress * 120 + cursorY * 60}px)`,
        }}
      />
      ...
      >
        ...
        <h2 
          ...
          style={{
            transform: `translateY(${cursorY * -25}px) translateX(${cursorX * -15}px)`,
          }}
        >
          Let&apos;s Work
        ...
        >
          I&apos;m currently looking for opportunities in AI/ML Engineering, Data Science, 
          and Computer Vision. Whether you have a question or just want to say hi, 
        ...
        >
          <a
            ...
            style={{
              transform: `perspective(500px) rotateY(${cursorX * 8}deg) rotateX(${cursorY * -5}deg)`,
            }}
          >
            Say Hello
        ...
        >
          {[
            { href: "https://github.com/amangaikwad", icon: Github, label: "GitHub" },
            { href: "https://linkedin.com/in/amangaikwad", icon: Linkedin, label: "LinkedIn" },
            { href: "mailto:aman@example.com", icon: Mail, label: "Email" },
          ].map((social, index) => (
            <a
              key={social.label}
              href={social.href}
              ...
              style={{
                transform: `
                  translateX(${cursorX * (index - 1) * 25}px)
                  translateY(${cursorY * 15}px)
                `,
              }}
            >
