    ...
    >
      <div
        ...
        style={{
          transform: `translate(${cursorX * 130}px, ${
            sectionProgress * 200 + cursorY * 70
          }px)`,
        }}
      />
      <div
        ...
        style={{
          transform: `translate(${-cursorX * 100}px, ${
            -sectionProgress * 160 + cursorY * 60
          }px)`,
        }}
      />
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6">
        <div
          ...
          style={{
            transform: `translateY(${(1 - sectionProgress) * 45}px) translateX(${
              cursorX * -20
            }px)`,
                  ...
                  {category.skills.map((skill, skillIndex) => (
                    <div
                      ...
                      style={{
                        ...
                        }px) translateX(${cursorX * (3 + skillIndex)}px)`,
                        opacity: sectionProgress,
                      }}
                    >
                      <div
